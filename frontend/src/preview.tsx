...
export default function Preview() {
  ...
  const getTrending = () => {
    fetch(
      "https://api.themoviedb.org/3/trending/movie/day?api_key=649f645abf4721a3027659369cc67c24"
    )
            ...
            <div className="preview--box" key={movie.id}>
              ...
              <div id="arrow" className="arrow arrow--down">
                <img
                  width="100%"
                  height="100%"
                  src="https://drive.google.com/thumbnail?id=1Wbr9InCz4paNVd2AP18UUIhrHAdVrmgi&sz=w1000"
                  alt=""
                />
              </div>
            </div>
